  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../main.html" class="brand-link">
      <img src="../../dist/img/AdminLTELogo.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">AdminInternship</span>
    </a>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Output NamaAPI</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start ?>-->
              <form role="form" id="quickForm" action="">
                ...
                <a href="<?php echo base_url('pages/forms/namaapi.php'); ?>" class="button">Back</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
